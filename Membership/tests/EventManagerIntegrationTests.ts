...
declare var assert: (message: string, expected: any, actual: any) => void;
declare var config: any;

export class EventManagerIntegrationTests {
    private eventManager = modelFactory.eventManager();
    private eventData = {
    ...
    run() {
        ...
        this.test_getEventList();
        this.test_getUpcomingEvents();
        this.test_getAvailableEvents();
        // this.test_addEvent();
        this.test_updateEvent();
        // this.test_deleteEvent();
    ...
    test_getEventList() {
        try {
            ...
            eventsResponse.data.forEach((event: any, idx: number) => {
    ...
    test_delete_event_item(eventId: any) {
        try {
    ...
    test_get_calendar_resources() {
        try {
            ...
            resources.forEach((resource: any, idx: number) => {
    ...
    test_unregister_member_from_event() {
        ...
        try {
            ...
            const isAttendee = updatedEvent.attendees.some((attendee: any) => attendee.id === testMemberId);
