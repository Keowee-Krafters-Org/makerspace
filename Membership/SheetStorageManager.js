class SheetStorageManager extends StorageManager {
    constructor(storageName, clazz) {
        super(); // Optionally pass fieldMap if needed
        ...
        const sheetName =  SharedConfig[storageName].sheet.name; 
          ...
          this.clazz = clazz; // Store the class for row-object conversion
      }
    ...
    add(record) {
       ...
       * @param {Function} clazz - The class with a fromRecord method to map rows to objects.
